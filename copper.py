...
st.set_page_config(page_title='Industrial copper',page_icon=icon,initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by Akash P'})
    ...
    if select == 'Selling Price':
        ...
        if button:
            ...
            if not all([item_date, delivery_date, country, item_type, application, product_ref,
                ...
                with open('E:\Guvi Projects\Copper Project\Regressor.pkl','rb') as files:
    ...
    if select == 'Status':
        ...
        if button:
            ...
            if not all([item_date, delivery_date, country, item_type, application, product_ref,
                ...
                with open('E:\Guvi Projects\Copper Project\Classifier.pkl','rb') as files:
...
if selected == "About":
    ...
    st.markdown('''**Hello! I'm Akash, a B.E. graduate with a keen interest in data science and analytics.
                Currently on an exciting journey into the world of data science...**''')
    st.link_button('Linkedin','https://www.linkedin.com/in/arun-kumar-m-82ba5418a/') 
